...
$('#syllabus').on('submit', function (e) {

	if ($('#syllabus select[name="classsyllabus"]').val() === '') {

		alert('Select Syllabus Class');

		$('#syllabus select[name="classsyllabus"]').focus(); return false;

	}

	if ($('#syllabus input[name="title"]').val() === '') {

		alert('Enter Syllabus Title');

		$('#syllabus input[name="title"]').focus(); return false;

	}

	if ($('#syllabus input[name="orderby"]').val() === '') {

		alert('Enter orderby number');

		$('#syllabus input[name="orderby"]').focus(); return false;

	}

	var edit = $('#syllabus input[name="edit"]').val();

	var filesname = document.getElementById("filesname");

	if (edit == 0 || edit == '') {

		if (filesname.files.length == '' || filesname.files.length == 0) {
		...
		var file = filesname.files[0];

		var doc = file.name.split('.').pop().toLowerCase();

		if ($.inArray(doc, ['docx', 'doc', 'pdf']) == -1 && doc != '') {

			alert('Invalid Document file format! Only formats are allowed : .docx, .doc, .pdf')
	...
	//alert(filesname.files.length);return false;
...
$('#uploadflash').on('submit', function (e) {



	if ($('#uploadflash input[name="title"]').val() === '') {

		alert('Enter Title');

		$('#uploadflash input[name="title"]').focus(); return false;

	}

	if ($('#uploadflash input[name="orderby"]').val() === '') {

		alert('Enter orderby number');

		$('#uploadflash input[name="orderby"]').focus(); return false;

	}

	var edit = $('#uploadflash input[name="edit"]').val();

	var filesname = document.getElementById("image");
	...
	if (edit == 0 || edit == '') {
		...
		if ($.inArray(doc, ['jpeg', 'jpg', 'png', 'PNG', 'JPG', 'JPEG']) == -1 && doc != '') {

			alert('Invalid image file format! Only formats are allowed : .jpeg,.jpg,.png')
...
$('#noticeboard').on('submit', function (e) {



	if ($('#noticeboard input[name="noticedate"]').val() === '') {

		alert('Enter Date');

		$('#noticeboard input[name="noticedate"]').focus(); return false;

	}

	if ($('#noticeboard input[name="orderby"]').val() === '') {

		alert('Enter orderby number');

		$('#noticeboard input[name="orderby"]').focus(); return false;

	}

	if ($('#noticeboard textarea[name="notice"]').val() === '') {

		alert('Enter Content');

		$('#noticeboard textarea[name="notice"]').focus(); return false;
...
$('#newsevents').on('submit', function (e) {



	if ($('#newsevents input[name="title"]').val() === '') {

		alert('Enter Title');

		$('#newsevents input[name="title"]').focus(); return false;

	}

	if ($('#newsevents input[name="noticedate"]').val() === '') {

		alert('Enter Date');

		$('#newsevents input[name="noticedate"]').focus(); return false;

	}

	if ($('#newsevents input[name="orderby"]').val() === '') {

		alert('Enter orderby number');

		$('#newsevents input[name="orderby"]').focus(); return false;

	}

	if ($('#newsevents textarea[name="notice"]').val() === '') {

		alert('Enter Content');

		$('#newsevents textarea[name="notice"]').focus(); return false;
...
$('#galleryimages').on('submit', function (e) {



	var edit = $('#galleryimages input[name="edit"]').val();



	if ($('#galleryimages select[name="Category_id"]').val() === '') {

		alert('Enter Category');

		$('#galleryimages select[name="Category_id"]').focus(); return false;

	}

	if ($('#galleryimages input[name="eventdate"]').val() === '') {

		alert('Enter Event Date');

		$('#galleryimages input[name="eventdate"]').focus(); return false;

	}

	if ($('#galleryimages textarea[name="description"]').val() === '') {

		alert('Enter Description');

		$('#galleryimages textarea[name="description"]').focus(); return false;

	}

	if ($('#galleryimages input[name="orderby"]').val() === '') {

		alert('Enter orderby number');

		$('#galleryimages input[name="orderby"]').focus(); return false;

	}



	if ($('#galleryimages input[name="image"]').val() === '' && edit === 0) {

		alert('Select Image');

		$('#galleryimages input[name="image"]').focus(); return false;
...
$('#birthdaystudent').on('submit', function (e) {



	var edit = $('#birthdaystudent input[name="edit"]').val();



	if ($('#birthdaystudent input[name="admNo"]').val() === '') {

		alert('Enter Adm No');

		$('#birthdaystudent input[name="admNo"]').focus(); return false;

	}

	if ($('#birthdaystudent input[name="title"]').val() === '') {

		alert('Enter student name');

		$('#birthdaystudent input[name="title"]').focus(); return false;

	}

	if ($('#birthdaystudent input[name="gender"]').val() === '') {

		alert('Enter Sex');

		$('#birthdaystudent input[name="gender"]').focus(); return false;

	}

	if ($('#birthdaystudent input[name="classes"]').val() === '') {

		alert('Enter Class');

		$('#galleryimages input[name="classes"]').focus(); return false;

	}

	if ($('#birthdaystudent input[name="rollnumber"]').val() === '') {

		alert('Enter roll number');

		$('#birthdaystudent input[name="rollnumber"]').focus(); return false;

	}

	if ($('#birthdaystudent input[name="dateofbirth"]').val() === '') {

		alert('Enter date of birth');

		$('#birthdaystudent input[name="dateofbirth"]').focus(); return false;

	}

	if ($('#birthdaystudent input[name="admissiondate"]').val() === '') {

		alert('Enter admission date');

		$('#birthdaystudent input[name="admissiondate"]').focus(); return false;

	}

	if ($('#birthdaystudent input[name="orderby"]').val() === '') {

		alert('Enter orderby number');

		$('#birthdaystudent input[name="orderby"]').focus(); return false;

	}



	if ($('#birthdaystudent input[name="image"]').val() === '' && edit === 0) {

		alert('Select Image');

		$('#birthdaystudent input[name="image"]').focus(); return false;
...
$(".deletesyllabus").on('click', function () {
...
$(".birthdaynotice").on('click', function () {
...
$(".deletenotice").on('click', function () {
	...
	if (confirm("Are you sure, want to delete?")) {
		...
		$.ajax({
			...
			url: 'noticeboardDelete/' + DeleteId,
...
$(".deletegallery").on('click', function () {
	...
	if (confirm("Are you sure, want to delete?")) {
		...
		$.ajax({
			...
			url: 'uploadflashDelete/' + DeleteId,
...
$(".deletegallcat").on('click', function () {
...
$(".deletegalleryimage").on('click', function () {
	...
	if (confirm("Are you sure, want to delete?")) {
		...
		$.ajax({
			...
			url: 'deletegalleryimage/' + DeleteId,
...
$(".deletestudentmaster").on('click', function () {
	...
	if (confirm("Are you sure, want to delete?")) {
		...
		$.ajax({
			...
			url: 'deletestudentmaster/' + DeleteId,
...
$(".deleteinvitation").on('click', function () {
	var DeleteId = $(this).attr("id");
	var trid = $(this).closest('tr').attr('id');

	if (confirm("Are you sure, want to delete?")) {
		$.ajax({
			url: 'deleteinvitation/' + DeleteId,
			type: 'GET',
			dataType: 'json',
			success: function (result) {
				if (result.success) {
...
$(".id-btn-dialog1").on('click', function (e) {
	...
	$('#myModal').modal('show');
	$('.studentId').removeAttr('checked',true);
	$('.CheckAll').removeAttr('checked',true);
});
$(".sndsms").on('click', function () {
	var mobileno = $('#mobileno').val();
	
	var feedbackmessage = $('#feedbackmessage').val();
	var val = [];var val1 = [];
	$('.studentId:checkbox:checked').each(function(i){
	  val[i] = $(this).val();
	});
	...
	$.ajax({
		url: 'sendsms',
		type: 'POST',
		data: {mobileno:mobileno,studentId:studentId,feedbackmessage:feedbackmessage},
		headers: {
...
$('.studentId').click(function(){
	var check = $('.studentId:checkbox:checked').length;
	if(check){
		$('#save_value').show();
	}else{
		$('#save_value').hide();
...
$(document).on("change", "#classFilter,#branchFilter", function (e) { 
        //e.preventDefault();
        var student_class = $('#classFilter').val(); 
        var branch = $('#branchFilter').val(); 

        $.ajax({
            url: site_url + '/get-filtered-students',
            type: 'POST',
            data: {student_class: student_class,branch: branch},
            dataType: 'json',
            ...
            success: function (result) {
                if (result) {  //alert(result);
                    ...
                    $.each(result.data, function (i, item) {
                        if(!item.Roll_No){item.Roll_No='N/A';}
						if(!item.admission_no){item.admission_no='N/A';}
						if(!item.branch){item.branch='N/A';}
					
						HTML += '<option value="' + item.id + '">' + item.student_name + ' (CL: ' + item.present_class+ ', Roll:'+ item.Roll_No+ ', Adm No:'+ item.admission_no+ ', Br:'+item.branch+')</option>'; 
                    });
                    $('#student_master_id').html(HTML); 
...
//$('#select2-data-student_master_id').css('max-height', '200px !important');  
  
$(document).on("click", "#select_all", function (e) { 
	
		$("#student_master_id > option").prop("selected","selected");
        // $("#student_master_id").trigger("change"); 
        $("#student_master_id").select2('destroy'); 
		$("#student_master_id").select2(); 
	
});

$(document).on("click", "#deselect_all", function (e) { 
	
		$("#student_master_id > option").removeAttr("selected");
         $("#student_master_id").select2(); 
...
$(document).on("click", ".submitInvite", function (e) { 
		...
		var student_master_id = $('#student_master_id').val();
		
		if(!quizid){
			alert('Please select Exam!'); return false;
		}
		if(!student_master_id){
			alert('Please select Students!'); return false;
		}
        $.ajax({
            url: site_url + '/invitation',
            type: 'POST',
			data: {quizid: quizid,student_master_id:student_master_id},
            dataType: 'json',
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            beforeSend: function () { 
                $('.loader_data').html('<div class="loading">Loading&#8230;</div>');
				$('.submitInvite').prop('disabled', true);
            },
            success: function (result) {
	...
	$(document).on("click", ".submitSchedule", function (e) { 
        e.preventDefault();
		...
		if(!scheduledate){
			alert('Please select schedule date!'); return false;
		}
		if(!quizid){
			alert('Please select Exam!'); return false;
		}
        ...
        $.ajax({
            url: site_url + '/schedulessms',
            type: 'POST',
			data: {quizid: quizid,student_master_id:student_master_id,scheduledate:scheduledate,classFilter:classFilter},
            dataType: 'json',
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            beforeSend: function () { 
                $('.loader_data').html('<div class="loading">Loading&#8230;</div>');
