    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" method="post" role="form" action="{{url('newspaper')}}">
                    {{csrf_field()}}
                    <input type="hidden" name="page_name" value="newspaper">
                    <div class="form-group">
                        <label for="form-field-1"> News Paper </label>
